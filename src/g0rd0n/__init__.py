"""g0rd0n — a bookkeeping machine for a research programme.

The programme's task is in `AGENTS.md`. This package's task is narrower: to make sure that
every claim the programme makes can be traced to what it cost, who made it, and what would
have refuted it.
