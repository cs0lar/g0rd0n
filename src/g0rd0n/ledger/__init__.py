...
away from anywhere in the system. Delete it and callers reach into
`g0rd0n.ledger.ledger.Ledger`, coupling every layer to a file layout rather than to the
three operations, which is the first step towards a fourth one appearing.
"""
